...
(function(){
  ...
  function renderNav(){
    ...
    return ''
      ...
      +       '<span><i class="fa-regular fa-envelope" style="margin-right:6px; color:var(--um-gold-soft)"></i> <a href="mailto:nursing@um.edu.my">nursing@um.edu.my</a></span>'
      +       '<span><i class="fa-solid fa-phone" style="margin-right:6px; color:var(--um-gold-soft)"></i> +603 7967 XXXX</span>'
      +     '</div>'
  ...
  function renderFooter(){
    return ''
      ...
      +         '<h5>Connect</h5>'
      +         '<ul style="list-style:none; padding:0; margin:0; display:flex; flex-direction:column; gap:10px;">'
      +           '<li><a href="mailto:nursing@um.edu.my">nursing@um.edu.my</a></li>'
      +           '<li><a href="tel:+60379670000">+603 7967 XXXX</a></li>'
